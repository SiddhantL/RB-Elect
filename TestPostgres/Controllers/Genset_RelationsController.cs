...
namespace TestPostgres.Controllers
{
    ...
    public class Genset_RelationsController : ControllerBase
    {
        ...
        [HttpGet("{usertype}/{companyid}")]
        public List<Genset_Relation> Details(string usertype, int companyid)
        {
            return _dataAccessProvider.GetGensetRelationList(usertype, companyid);
        }
        /*   [HttpPost]
