...
namespace TestPostgres.Controllers
{
    ...
    public class Company_DetailsController : ControllerBase
    {
        ...
        public Company_DetailsController(IDataAccessProvider dataAccessProvider)
        {
            _dataAccessProvider = dataAccessProvider;
        }

        [HttpGet]
        public IEnumerable<Company_Details> Get()
        {
            return _dataAccessProvider.GetCompanyDetailsRecords();
        }
        [HttpGet("{id}")]
        public Company_Details Details(int id)
        {
            return _dataAccessProvider.GetCompanyDetailSingleRecord(id);
        }
        /*   [HttpPost]
