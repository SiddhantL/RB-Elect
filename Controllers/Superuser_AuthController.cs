...
namespace TestPostgres.Controllers
{
    ...
    public class Superuser_AuthController : ControllerBase
    {
        private readonly IDataAccessProvider _dataAccessProvider;

        public Superuser_AuthController(IDataAccessProvider dataAccessProvider)
        {
            _dataAccessProvider = dataAccessProvider;
        }

        [HttpGet]
        public IEnumerable<Superuser_Auth> Get()
        {
            return _dataAccessProvider.GetSuperuserAuthRecords();
        }
